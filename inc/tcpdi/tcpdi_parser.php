...
require_once __DIR__ . '/../tcpdf/include/tcpdf_filters.php';

if ( ! class_exists( 'WaterWoo_tcpdi_parser' ) ) :
    ...
    // -----------------------------------------------------------------------------
        ...
        public function __construct( $data, $uniqueid, $cfg = array() ) {       
            ...
            $this->FilterDecoders = new WaterWoo_TCPDF_FILTERS();
        ...
        public function _getMetaData() {
            $metadata = $this->getObjectVal($this->xref['trailer'][1]['/Info']);
            return $metadata;
        }
         ...
         * @param $offset (int) xref offset (if known).
        ...
        protected function getRawObject( $offset = 0, $data = null ) {
            ...
            // 2.2.2 to address https://github.com/SD-dthompson/tcpdi_parser/commit/fee436f3e9eaf1fd9aaffeb43cc2fec742b638be
            ...
            switch ($char) {
                case '%': { // \x25 PERCENT SIGN
                    ...
                    if ($next > 0) {
                        $offset += $next;
                        // Since 2.10.1
                        // https://github.com/pauln/tcpdi_parser/pull/23/commits/3bacfdc8ea0d391a01daa9507d941574de5a97bb
        ...
        private function _getPageContent($content_ref) {
            ...
            if ($content_ref[0] == PDF_TYPE_OBJREF) {
                ...
                if ($content[1][0] == PDF_TYPE_ARRAY) { // TODO: PHP 7.4
        ...
        public function Error($msg) {
            if (defined('K_TCPDF_THROW_EXCEPTION_ERROR') AND !K_TCPDF_THROW_EXCEPTION_ERROR) {
                die('<strong>WaterWoo (TCPDI_PARSER) ERROR: </strong>'.$msg);
            } else {
                throw new Exception('WaterWoo (TCPDI_PARSER) ERROR: '.$msg);
            }
        }

    } // END OF littlep_tcpdi_parser CLASS
